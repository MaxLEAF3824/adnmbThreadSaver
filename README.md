...
This is a simple python script, which saves threads from adnmb.com, it's based on selenium so you a corresponding webdriver for your own web browser. This repo includes the source code and an executable file.(But Runing the exe requires an extra webdriver file, which is expected to be downloaded by yourself.)  
